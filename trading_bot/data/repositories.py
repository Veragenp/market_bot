    ...
    for e in events:
        cursor.execute(
            ...
            INSERT INTO level_events (
                ...
                level_price, event_status, pre_side, volume_peak, duration_hours, atr_daily, atr_pct, dist_start_atr,
                touch_time, return_time, penetration_atr, penetration_pct, rebound_pure_atr, rebound_pure_pct, rebound_after_return_atr, rebound_after_return_pct,
                confirm_time, confirm_time_sec, touch_count_before_confirm, cluster_size, window_start, window_end, created_at
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT(event_id) DO UPDATE SET
                ...
                rebound_pure_pct = excluded.rebound_pure_pct,
                rebound_after_return_atr = excluded.rebound_after_return_atr,
                rebound_after_return_pct = excluded.rebound_after_return_pct,
                confirm_time = excluded.confirm_time,
                confirm_time_sec = excluded.confirm_time_sec,
                touch_count_before_confirm = excluded.touch_count_before_confirm,
            ...
            (
                ...
                e.get("penetration_pct"),
                e.get("rebound_pure_atr"),
                e.get("rebound_pure_pct"),
                e.get("rebound_after_return_atr"),
                e.get("rebound_after_return_pct"),
                e.get("confirm_time"),
                e.get("confirm_time_sec"),
                e.get("touch_count_before_confirm"),
                e.get("cluster_size"),
                e.get("window_start"),
                e.get("window_end"),
                now,
