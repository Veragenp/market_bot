...
Это тонкая обёртка над `trading_bot/entrypoints/export_volume_peaks_to_sheets_only.py`,
...
_ORIG = MARKET_BOT_ROOT / "trading_bot" / "entrypoints" / "export_volume_peaks_to_sheets_only.py"
